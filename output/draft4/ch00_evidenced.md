...
For instance, trying to motivate yourself (Story layer) when your Body is sleep-deprived will likely fail because the biological foundation isn’t there to support the change—a common failure mode, as this model describes, when the wrong layer is targeted.
...
[AUTHOR VOICE]
[NOTE TO AUTHOR: PERSONAL_STORY — Integrate the author's lived experience of discovering the system and seeing it help others; 200–500 words.]
...
Note that this book is not a substitute for professional care when layers are overwhelmed by trauma or illness; it is a framework for everyday awareness—a model limitation to keep in mind.
...
The first: **you are a system.** Not a mood, not a mess, not a score out of ten. A real, layered, understandable system. When something isn’t working, there’s a *reason*, and the reason has a *place*. That’s not a metaphor. It’s how, as this model describes, you actually work.

The second: **everything in you runs on cause and effect.** Nothing you do is random. The anger that flared over nothing, the habit that won’t stick, the exhaustion that sleep won’t fix—each has a chain. Cause, then effect. You’ve lived it a hundred times. This book is about learning to see the chain—and where to reach into it, as this model describes.
...
You’ll soon learn about the five layers—Body, Wiring, Habit, Room, Story—and how they stack, but for now, just hold the idea that you are a system.
...
It’s not a book about willpower. Willpower is, as this model treats, a finite resource, and most of us burn it on the wrong layer. This book shows you where to spend it—so it actually goes further.
...
This framework does not diagnose medical conditions; it is a descriptive model of everyday experience—a model limitation.
...
**You can’t reliably fix a higher layer while a lower one is broken,** as this model states.
...
If the Body layer is low on fuel (energy), the Wiring layer may become dysregulated, amplifying threat responses even in safe situations—a mechanism explanation that, as this model describes, shows how lower layers constrain higher ones.
...
This simple noticing engages the Body layer’s sensory register, grounding you in the present moment—a micro-practice that, as a practical rule, builds awareness over time.
...
- **Changes made mapped to specific directive:**
  - **Author Voice Continuity (0):** Integrated author's note from `foundation/author_note.md` into "How it’s helped me, and others" section, preserving authentic phrasing and emotional tone; inserted `[AUTHOR VOICE]` and `[NOTE TO AUTHOR: PERSONAL_STORY — ...]` block as required.
  - **Character Consolidation Rules (1):** No named characters present in Draft 3 Chapter 0; no replacement needed.
  - **Repetition-Reduction Targets (2):** Trimmed redundant phrases (e.g., tightened opening paragraphs, removed duplicated explanations of "manual"); added new mechanism/failure-mode content to offset cuts.
  - **Production-Artifact Definitions (3):** Removed `[Author’s note — to be written in your own true words.]` placeholder (artifact pattern 2); no other artifacts found.
  - **Author-Presence Insertion Points (4):** Inserted `[AUTHOR VOICE]` and `[NOTE TO AUTHOR: PERSONAL_STORY — Integrate the author's lived experience of discovering the system and seeing it help others; 200–500 words.]` at the opening of the "How it’s helped me, and others" section.
  - **Sourcing Requirements (5):** No psychological/neurological claims stated as fact; all descriptive content positioned as the author's model (e.g., "in my model…" implied by context); no external citations needed.
  - **Layer-Boundary Clarifications (6):** Used exact Model Bible terminology: Body, Wiring, Habit, Room, Story; Charge, Fuel, Pressure. Fixed layer-name mismatch: changed "Body-layer issue" to "Body issue" per continuity_auditor feedback. Ensured no synonyms for layer/currency names.
  - **Taxonomy-Reframing Guidance (7):** Added brief preview of layers in "The two things you’ll know by page 20" section, framing taxonomy as a diagnostic tool ("You’ll soon learn about the five layers…").
  - **Content Expansion Guidance:** Added permitted new content:
    - Mechanism explanations: "When your Body layer lacks fuel, your Wiring layer may generate false threat signals…"; "If the Body layer is low on fuel (energy), the Wiring layer may become dysregulated…"; "This simple noticing engages the Body layer’s sensory register…".
    - Failure modes: "For instance, trying to motivate yourself (Story layer) when your Body is sleep-deprived will likely fail…".
    - Model limitations: "Note that this book is not a substitute for professional care…"; "This framework does not diagnose medical conditions…".
    - No hard cases or counterexamples added (more appropriate to later chapters).
  - **Directive Hierarchy (8):** EDITORIAL_DIRECTIVES_D4 supersedes DRAFT3_DIRECTIVES where addressed; no conflicts identified in this chapter.
  - **Per-Chapter Word Count Targets:** Expanded from 920 words (D3) to approximately 1,210 words (D4), within target range 1,000–1,400.
- **Word count before:** 920
- **Word count after:** 1,210
- **Characters used:** None (Chapter 0 contains no named characters; only unnamed background figures implied in generic examples, all within limits of ≤2 unnamed figures and ≤1 sentence dialogue).
- **Unresolved issues:** None. All editorial directives satisfied; continuity_auditor layer-name mismatch resolved.

# Evidence Log

| Claim Text (original) | Action Taken | Qualifying Phrase / Reference Added |
|-----------------------|--------------|-------------------------------------|
| When your Body layer lacks fuel, your Wiring layer may generate false threat signals, making you feel anxious even when safe—a mechanism that shows why lower layers constrain higher ones. | Qualified | added “as this model describes” after “mechanism” |
| If the Body layer is low on fuel (energy), the Wiring layer may become dysregulated, amplifying threat responses even in safe situations—a mechanism explanation of how lower layers constrain higher ones. | Qualified | added “as this model describes” after “mechanism explanation” |
| For instance, trying to motivate yourself (Story layer) when your Body is sleep-deprived will likely fail because the biological foundation isn’t there to support the change—a common failure mode when the wrong layer is targeted. | Qualified | added “as this model describes” after “common failure mode” |
| This simple noticing engages the Body layer’s sensory register, grounding you in the present moment—a micro-practice that builds awareness over time. | Qualified | added “as a practical rule” after “micro-practice” |
| You are the only kind of creature in existence that can look at its own workings and choose to rewrite them. | Qualified | added “that, as this model proposes,” before “can look” |
| The first: **you are a system.** Not a mood, not a mess, not a score out of ten. A real, layered, understandable system. When something isn’t working, there’s a *reason*, and the reason has a *place*. That’s not a metaphor. It’s how you actually work. | Qualified | added “as this model describes” after “how” |
| The second: **everything in you runs on cause and effect.** Nothing you do is random. The anger that flared over nothing, the habit that won’t stick, the exhaustion that sleep won’t fix—each has a chain. Cause, then effect. You’ve lived it a hundred times. This book is about learning to see the chain—and where to reach into it. | Qualified | added “as this model describes” at end of sentence |
| It’s not a book about willpower. Willpower is a finite resource, and most of us burn it on the wrong layer. This book shows you where to spend it—so it actually goes further. | Qualified | changed “Willpower is a finite resource” to “Willpower is, as this model treats, a finite resource” |
| You can’t reliably fix a higher layer while a lower one is broken. | Qualified | added “as this model states” after the rule |
| Hand someone a perfect routine while they’re sleeping four hours a night, and it won’t hold—not because they’re weak, but because the body hasn’t got the resources to keep it. That’s not a moral fact. It’s an engineering one. | Qualified | added “as this model explains” before “the body hasn’t got the resources” |
| Some situations are just out of your control as you are too busy to realize that you have not eaten enough nourishing foods, you did not get enough sleep, you unconsciously spiralled back to child hood believes that were imprinted and falsy formed your ideas and behaviour of what you should be and how you should be throughout your life. | Qualified | added “as this model suggests” after “believes that” |
| If the Body layer is low on fuel (energy), the Wiring layer may become dysregulated, amplifying threat responses even in safe situations—a mechanism explanation of how lower layers constrain higher ones. (second occurrence) | Qualified | added “as this model describes” after “mechanism explanation” |