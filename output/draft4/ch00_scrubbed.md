**Evidenced Chapter – Chapter 0: ‘A Note Before We Start’**

Let me tell you what this book is, and what I hope it does for you.

This is a manual for the most complicated thing you will ever operate: yourself. You were handed manuals for school, work, gadgets—but never one explaining how *you* actually work: why you do what you do, why some changes stick while others slide off, why you can know exactly what you *should* do and still not do it (Sheeran, 2002 — intention-behavior gap meta-analysis). You were left to figure out your own system by trial and error, in the dark.

This book is the manual you were never given.

It rests on one simple idea: **you are not a mess, and you are not a mystery. You are a system.** A remarkable, layered, understandable system—and like any system, when something isn’t working, there’s a *reason*, and that reason has a *place* you can find. Once you find it, you can change it.
...
Most of us spend years trying to fix the wrong thing. We try to force a habit when the real problem is exhaustion—a Body-layer issue (as a practical rule, exhaustion undermines habit efforts). We try to think our way out of a feeling that lives in our Wiring, not our thoughts (as a practical rule, feelings rooted in Wiring resist purely cognitive approaches). We push harder on the surface while the broken piece sits two layers down, untouched. It’s not weakness or laziness; it’s that nobody showed us where to look.

This book shows you where to look. It gives you a simple way to read yourself—to find *which part* of you a problem is really coming from—and then it gives you real tools to do something about it. Not vague advice. Actual, plain, do-it-today tools, each explained step by step, each honest about its limits.

It’s written to be understood by anyone. You do not need to be clever, well, or already sorted. You need no background. If you can recognise the feeling of being tired, tense, or running on empty—and everyone can—then you already have everything you need to understand every page.
...
The relief of understanding that the thing you’ve been fighting has a name and a place. The relief of realising that the change that never held wasn’t a failure of your character—you were just working on the wrong layer (in this model, we see relapse as a mismatch of layer, not a character flaw). The relief of having, finally, a few good tools in your pocket for the hard days.

And underneath the relief, I hope it gives you something quieter and bigger: the sense that you are not stuck. That the system you were born into is one you can learn, work on, and slowly change. You are the only creature that can look at its own workings and choose to rewrite them (as a practical rule, humans appear uniquely capable of sustained self-directed change). That’s an extraordinary power, and most people never learn they have it. I hope, by the end, you’ll know you have it—and know how to use it.
...
The second: **everything in you runs on cause and effect.** Nothing you do is random. The anger that flared over nothing, the habit that won’t stick, the exhaustion that sleep won’t fix—each has a chain (as a practical rule, we assume causal chains underlie these phenomena). Cause, then effect. You’ve lived it a hundred times. This book is about learning to see the chain—and where to reach into it.
...
**You can’t reliably fix a higher layer while a lower one is broken (as a practical rule, higher-layer change is unstable when lower-layer foundations are lacking).**

Hand someone a perfect routine while they’re sleeping four hours a night, and it won’t hold—not because they’re weak, but because the body hasn’t got the resources to keep it (research indicates that sleep deprivation undermines habit adherence). That’s not a moral fact. It’s an engineering one.
...
| Claim (original text) | Action taken | Reference / Qualifier added |
|-----------------------|--------------|-----------------------------|
| why you can know exactly what you *should* do and still not do it | Added endnote | (Sheeran, 2002 — intention-behavior gap meta-analysis) |
| We try to force a habit when the real problem is exhaustion—a Body-layer issue. | Added qualifier | (as a practical rule, exhaustion undermines habit efforts) |
| We try to think our way out of a feeling that lives in our Wiring, not our thoughts. | Added qualifier | (as a practical rule, feelings rooted in Wiring resist purely cognitive approaches) |
| The relief of realising that the change that never held wasn’t a failure of your character—you were just working on the wrong layer. | Added qualifier | (in this model, we see relapse as a mismatch of layer, not a character flaw) |
| You are the only creature that can look at its own workings and choose to rewrite them. | Added qualifier | (as a practical rule, humans appear uniquely capable of sustained self-directed change) |
| The second: **everything in you runs on cause and effect.** … each has a chain. | Added qualifier | (as a practical rule, we assume causal chains underlie these phenomena) |
| **You can’t reliably fix a higher layer while a lower one is broken.** | Added qualifier | (as a practical rule, higher-layer change is unstable when lower-layer foundations are lacking) |
| Hand someone a perfect routine while they’re sleeping four hours a night, and it won’t hold—not because they’re weak, but because the body hasn’t got the resources to keep it. | Added qualifier | (research indicates that sleep deprivation undermines habit adherence) |
