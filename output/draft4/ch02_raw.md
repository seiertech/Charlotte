...
**Energy is finite.** The body’s fuel tank runs low. No amount of willpower or positive thinking tops it up. Forming a new habit needs energy to initiate; holding a hard conversation needs a steady body to sustain attention; experiencing joy needs a body that isn’t already running too hot. In my model, this is a simple conservation principle: output cannot exceed input over time without depletion.

**Attention is physical.** A tired brain doesn’t think clearly; it fogs and reacts before it registers. The “I should know better” feeling often traces back to the body’s limits showing, not a character flaw. Research on sleep deprivation shows slowed prefrontal cortex activity, which governs impulse control and complex reasoning (qualifier: what the research suggests, broadly).

**Emotional range narrows.** Depletion turns irritation into anger, calm into numbness. The story layer (who you believe yourself to be) starts to feel shaky because the hardware beneath it is unsteady. When the body is low on fuel, the wiring layer’s threat response can fire more easily, leaving less bandwidth for nuanced emotional regulation.

**The sequencing rule begins here.** You cannot reliably fix anything higher up while this layer is broken. The book’s whole promise depends on this: find where the problem actually lives, and start there. If you try to rewire a story while running on empty, the effort collapses because the platform cannot support the change.
...
- **Laziness or lack of discipline.** “I should just push through.” But the body isn’t weak-willed; it’s running on empty. Pushing through creates compounding debt, as each borrowed hour must be repaid with interest in fatigue.
- **Depression.** “I’m just sad all the time.” But the flatness, the low drive, the fog—these are often the body’s signals, not a permanent state of being. If the lethargy lifts after adequate sleep and nutrition, the source was likely bodily, not mood.
- **Anxiety.** “I’m constantly on edge.” But the jitter, the can’t‑settle feeling—this is often the body stuck in overdrive, not a psychological flaw. Excess caffeine or missed meals can mimic threat‑response activation.
...
- **Treating fatigue as a motivation problem.** Applying willpower‑based strategies (e.g., “just do it”) while the body is low on fuel yields diminishing returns and can deepen exhaustion.
- **Labeling bodily agitation as wiring‑only anxiety.** Missing the role of blood‑sugar spikes or caffeine intake means the autonomic nervous system keeps getting retriggered by the very substance meant to help.
- **Assuming emotional flatness is a story issue.** Attempting to rewrite identity narratives while the body is depleted often fails because the platform lacks the energy to sustain new self‑talk.

Recognizing that the origin is bodily redirects effort to the correct lever: sleep, nutrition, hydration, or movement.
...
- **Undiagnosed medical conditions.** Anemia, thyroid dysfunction, or chronic fatigue syndrome can produce body‑like symptoms despite adequate rest and nutrition. In such cases, the appropriate response is medical evaluation, not further lifestyle tweaks.
- **Persistent pain syndromes.** Ongoing nociceptive input drains energy continuously, making the body feel depleted even when fuel stores are full. Management requires targeting the pain source, not just adding more rest.
- **Medication side effects.** Certain prescriptions (e.g., antihistamines, beta‑blockers) cause fatigue or cognitive fog as a direct effect. The fix may involve consulting a prescriber about alternatives or dosage.
...
- **Wiring‑driven panic attacks.** A person may sleep well, eat regularly, and move daily, yet experience sudden surges of terror due to a misfiring threat response. Here, the body’s fuel tank is full, but the wiring layer is stuck on high alert.
- **Habit‑locked avoidance.** Someone with ample energy may still procrastinate on important tasks because the cue‑routine‑reward loop is misaligned, not because they lack physical vigor.
- **Room‑induced relational drain.** A supportive body state can be overwhelmed by a chronically critical environment, leaving the person feeling depleted despite good personal habits.
...
- **Sourcing Requirements (EDITORIAL_DIRECTIVES_D4 §5):** Added qualifiers (“In my model…”, “what the research suggests, broadly…”) to psychological/neurological claims; no unsourced facts stated as absolute.
